...
/* USER CODE BEGIN EV */
extern uint8_t ext_btn_up_value;
extern uint8_t ext_btn_down_value;
extern uint8_t ext_btn_left_value;
extern uint8_t ext_btn_right_value;
extern uint32_t clock_value;
